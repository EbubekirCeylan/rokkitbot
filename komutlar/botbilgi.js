...
module.exports.run = async(client, message, args) => {
  const duration = moment.duration(client.uptime).format(" D [gün], H [saat], m [dakika], s [saniye]");
    ...
    .addField(`Discord.js sürümü:`, Discord.version)
      .addField(':spy: Yapımcım:', '<@490082854773063681> \n `ZyuzAx`')
      .addField(':paperclip: Botun Başlanma Zamanı:', "Bot **02.02.2020**'de yapılmaya başlanmıştır")
    .setFooter('Rokkit |', client.user.avatarURL)
    .setTimestamp()
